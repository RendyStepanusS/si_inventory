                    ...
                    <form action="" method="POST">
                      ...
                      <div class="form-group-inner">
                        <div class="row">
                          ...
                          <div class="col-lg-2">
                            <input name="kode_kategori" type="text" class="form-control" value="<?= $kategori['kode_kategori']; ?>" autofocus />
                      ...
                      <div class="form-group-inner">
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            <input name="deskripsi" type="text" class="form-control" value="<?= $kategori['deskripsi']; ?>" />
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-3">
